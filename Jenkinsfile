    ...
    stages {
        ...
        stage('Run script') {
            steps {
               ...
               sh '. /opt/rh/gcc-toolset-15/enable; cd ./coot-build; echo now, the real build...; ls -alh; ls -alh ..; bash ../GPhL_script/dl_and_build_coot_cv-20260319.sh -os -distributable -noninteractive'
